...
inoremap <m-o> <cmd>lua GoToMainWindowAndRunCommand("Telescope frecency")<cr>
nnoremap <m-o> <cmd>lua GoToMainWindowAndRunCommand("Telescope frecency")<cr>
tnoremap <m-o> <cmd>lua GoToMainWindowAndRunCommand("Telescope frecency")<cr>
